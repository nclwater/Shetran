...
MODULE cm_link_state
   ...
   PUBLIC :: ACPBD1, ACPBDT, ACPBS, ACSFA1, ACPSF1, ACPSFT, CCBD1Q, CCPBK, CCPGS1, CCBS1Q, CCSFA1, &
             CCSF1Q, SCPBK, WCPBD1, VCPBK1, ICP1, ICPSBD, ICSBDC, ICSBDT, ICPSBS, ICSBSC, ICSBST, QCP1, &
             FCPBD, FCPBDC, FCBD1Q, FCPBDT, FCPBK, FCPBS, FCPBSC, FCBS1Q, FCPBST, FCPSW1, FCPSD, &
             FCPSDC, FCPSDT, FCPSF, FCSFA1, FCPSFC, FCSF1Q, FCPSFT, GCPBK, NCEBK, PCPBK1, PCPSB1, &
             PCSFA1, PCPSW1, PCSFM1, PCSFP1, ECPBD, ECPBDC, ECPBDT, ECPBS, ECPBSC, ECPBST, ECPSF, &
             ECPSFC, ECPSFT, USCP, ACSBD1, ACSBS1, GCPLAL, GCPLAQ
