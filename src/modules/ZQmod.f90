module ZQmod
    ...
    INTEGER, DIMENSION(:), ALLOCATABLE, SAVE                :: nZQcols                              ! use to dimension allocatable arrays
    INTEGER, DIMENSION(:), ALLOCATABLE, SAVE                :: nZQrows                              ! use to dimension allocatable arrays
    INTEGER, DIMENSION(:), ALLOCATABLE, SAVE                :: zcol                                 ! use to dimension allocatable arrays
    INTEGER, SAVE                                           :: i, j, k, printRow, printCol, pos     ! useful local integers
    ...
    DOUBLEPRECISION, DIMENSION(:,:), ALLOCATABLE, SAVE      :: headerRealArray                      ! real array to store weirEq stage thresholds
    DOUBLEPRECISION, DIMENSION(:,:,:), ALLOCATABLE, SAVE    :: ZQ                                   ! ZQ = 2D array (nZQrows, nZQcols)
    INTEGER, DIMENSION(:), ALLOCATABLE, SAVE                :: ZQTableOpHour                        ! the hour at which sluices are operated
