...
PROGRAM SHETRAN
   ...
   USE simulation_output, ONLY : extra_output  !< Generate extra output files
   ...
   ! Note: Windows-specific sleep and pause functions removed for portability
   ! The program now terminates cleanly on all platforms
