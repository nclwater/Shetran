...
MODULE vs_config
   ...
   PUBLIC :: BLOWP, BHELEV, NCSZON, NCRBED, JVSALN, ISRBED, NVSWL, NVSSP, NVSLF, NVSLH, NVSLG, NVSBF, &
             NVSBH, NVSBD, NVSWLC, NLBTYP, NLBCAT, NBBTYP, NBBCAT, NVSLFT, NVSLFL, NVSLFN, NVSLHT, &
             NVSLHL, NVSLHN, NVSLGT, NVSLGL, NVSLGN, IVSSTO, DCSZON, DCRBED, DCSTOT, DCRTOT, VSZMIN, &
             VSZMAX, VSK3D, DRBED, VSSPZ, VSSPCO, VSWV, VSWL, VSKR, WLNOW, RLFNOW, RLHNOW, RLGNOW, &
             RBFNOW, RBHNOW, BFAST, BSOILP, IVSFLG, IVSNTB, NVSERR, INITYP, VSTRES, VSVGN, VSALPH, &
             VSIPSD, VSZWLB, VSZWLT, TBPSI, TBTHE, TBKR, TBTHEC, TBKRC, VSSPD
