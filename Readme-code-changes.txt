...
change cobres sexample so it only needs 50 cells
...
time varying output step (in fr52)
  C:\Users\sjbir_000\Documents\sv4.4.3x64\sv4\code\FRmod.f90(25):                     SF, SMD, SD, TIMEUZ, TS, TIM, TMAX, TTH, UZVAL, VHT, VED, VSE,TOUTPUT                  
  C:\Users\sjbir_000\Documents\sv4.4.3x64\sv4\code\FRmod.f90(1797):    uznowt=uznow*(1/TOUTPUT)
    next_hour = INT(uznowt) + 1.0

  C:\Users\sjbir_000\Documents\sv4.4.3x64\sv4\code\FRmod.f90(1803):    uznowt=uznow*(1/TOUTPUT)
  ...
  C:\Users\sjbir_000\Documents\sv4.4.3x64\sv4\code\FRmod.f90(4359):READ (FRD, *) TOUTPUT
...
Outlet link and face now caculated correctly. Check it is type 7 (weir)
